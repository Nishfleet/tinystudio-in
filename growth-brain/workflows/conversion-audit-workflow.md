...
5. Rewrite only the sections needed to fix those failures.
6. Run the direct-response copy layer: headline, problem, agitate, credibility, solution, proof, CTA.
...
Do not ship a new page build, page rewrite, or lead form recommendation that fails headline clarity, above-fold value proposition, CTA ownership, form friction, or message match.
...
- Analytics, session recordings, heatmaps, or visible page evidence when available
