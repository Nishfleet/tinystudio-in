...
|---|---|---:|---:|---:|---:|---|---|
| AI Converter | delivery-proof-ready | 2 | 1 | 0 | 1 | complete | `clients/ai-converter/owned-product-proof-packet.md` |
| SiteRep | delivery-proof-ready | 1 | 1 | 0 | 1 | complete | `clients/siterep/owned-product-proof-packet.md` |
| Five to Nine 0509 | delivery-proof-ready | 4 | 1 | 0 | 1 | complete | `clients/five-to-nine-0509/owned-product-proof-packet.md` |
...
- Add product analytics or sales metrics before calling these full business case studies.
