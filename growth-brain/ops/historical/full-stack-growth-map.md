...
| Tier | Price | Best Fit | Channel Coverage |
| --- | --- | --- | --- |
| Proof Sprint | $1,000-$5,000 | First engagement; prove value before asking for a retainer. | CRO, search trust, ad/email angles, dashboard |
| Weekly Growth Desk | $2,000-$5,000/month | One visible improvement loop per week. | CRO, SEO basics, email/SMS, content angles, reputation, analytics |
| Full-Stack Growth Desk | $5,000-$12,000/month | Client has traffic, data, access, budget, and at least two ready growth channels. | SEO, paid search/social, lifecycle, content, CRO, reputation, analytics |
| Operator-Led Growth Pod | $12,000+/month | High-LTV client with multi-channel need and implementation capacity. | Senior strategy, channel owners, implementation support, monthly growth review |

## Channel Coverage

| Channel | What We Help With | Readiness Gate | Proof Output |
| --- | --- | --- | --- |
