...
handleHelp(args, `Usage: node src/export-client-repeatable-workflow.mjs clients/client-slug [--output=...] [--html=...]`);
...
if (!clientPath) {
  console.error("Usage: node src/export-client-repeatable-workflow.mjs clients/client-slug");
  process.exit(1);
}
