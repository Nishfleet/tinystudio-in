...
handleHelp(process.argv.slice(2), `Usage: node src/export-growth-cockpit.mjs [--output=runs/growth-cockpit.html]`);
...
runJson(["src/export-recording-cockpit.mjs", "--limit=5"]);
runJson(["src/export-lead-scoring-cockpit.mjs", "--limit=10"]);
runJson(["src/export-recording-teleprompter.mjs", "--limit=5"]);
runJson(["src/export-prospect-outbox.mjs"]);
runJson(["src/export-followup-cockpit.mjs"]);
runJson(["src/export-sales-cockpit.mjs"]);
runJson(["src/export-daily-money-mission.mjs", "--limit=5"]);
const metrics = runJson(["src/export-growth-metrics.mjs", "--output=runs/metrics-for-cockpit.md"]);
runJson(["src/export-proof-library.mjs"]);
runJson(["src/export-managed-it-one-pager.mjs"]);
runJson(["src/export-growth-doctor.mjs", "--no-checks"]);
runJson(["src/export-sender-setup-guide.mjs"]);
const todayResult = runJson(["src/show-growth-command-center.mjs"]);
