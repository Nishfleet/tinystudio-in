...
handleHelp(process.argv.slice(2), `Usage: node src/export-owned-product-case-studies.mjs [--output=growth-brain/ops/owned-product-case-studies.md] [--html=growth-brain/ops/owned-product-case-studies.html]`);
const clients = [
