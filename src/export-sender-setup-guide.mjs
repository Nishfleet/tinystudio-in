...
handleHelp(process.argv.slice(2), `Usage: node src/export-sender-setup-guide.mjs [--output=growth-brain/ops/sender-setup-guide.md] [--html=growth-brain/ops/sender-setup-guide.html]`);
...
const setup = runJson(["src/check-outbound-sender-setup.mjs"]);
