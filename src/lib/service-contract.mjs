...
export const ALLOWED_COMMANDS = Object.freeze(
	[
		["node", "src/check-client-readiness.mjs"],
		["node", "src/export-client-delivery-cockpit.mjs"],
		["node", "src/draft-client-kickoff.mjs"],
		["node", "src/review-client-proof.mjs", "--dry-run"],
		["node", "src/review-client-acceptance.mjs", "--dry-run"],
		["node", "src/check-prospect-readiness.mjs"],
		["node", "src/export-prospect-outbox.mjs"],
		["node", "src/export-followup-cockpit.mjs"],
		["node", "src/export-sales-cockpit.mjs"]
