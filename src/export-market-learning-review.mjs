...
handleHelp(process.argv.slice(2), `Usage: node src/export-market-learning-review.mjs [--output=runs/market-learning-review.md] [--html=runs/market-learning-review.html] [--limit=10]`);
...
const metrics = runJson(["src/export-growth-metrics.mjs", "--output=runs/metrics-for-learning.md"]);
