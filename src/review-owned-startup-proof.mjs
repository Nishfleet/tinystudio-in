...
const clientCommandRows = results.map((result) => ({
  ...
  handoffCockpitCommand: "node src/export-owned-handoff-loom-cockpit.mjs"
}));
...
5. Run \`node src/export-owned-handoff-loom-cockpit.mjs\` to record the tangible-improvement handoff Looms.
`;
