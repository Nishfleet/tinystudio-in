...
const readiness = runCodeRepoJson(["src/check-client-readiness.mjs", clientPath]);
...
for (const commandArgs of [
  ["src/export-client-delivery-cockpit.mjs", clientPath]
]) {
  runCodeRepoJson(commandArgs);
}

const updatedReadiness = runCodeRepoJson(["src/check-client-readiness.mjs", clientPath]);
