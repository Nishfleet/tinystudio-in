...
handleHelp(args, `Usage: node src/export-client-weekly-report.mjs clients/client-slug [--week=1] [--dates="May 1-7"] [--output=...]`);
...
if (!clientPath) {
  console.error("Usage: node src/export-client-weekly-report.mjs clients/client-slug [--week=1] [--dates=\"May 1-7\"]");
  process.exit(1);
}
...
const checkOutput = execFileSync("node", ["src/check-client-weekly-report.mjs", clientPath, `--report=${outputPath}`], {
  encoding: "utf8",
