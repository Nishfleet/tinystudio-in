...
//
// CLI:
//   node src/publish-public-site.mjs                          full pipeline
//   node src/publish-public-site.mjs --prepare-only [--output DIR]
//   node src/publish-public-site.mjs --deploy --bundle DIR    deploy+verify
