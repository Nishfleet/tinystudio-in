...
handleHelp(args, `Usage: node src/export-recording-rehearsal-check.mjs [--limit=5] [--output=prospects/recording-rehearsal-check.md] [--html=prospects/recording-rehearsal-check.html] [--include-smoke]`);
