...
handleHelp(process.argv.slice(2), `Usage: node src/export-owned-product-workflow-proofs.mjs [--output=growth-brain/ops/owned-product-workflow-proofs.md] [--html=growth-brain/ops/owned-product-workflow-proofs.html]`);
const clients = [
...
function runWorkflow(clientPath) {
  const output = execFileSync("node", ["src/export-client-repeatable-workflow.mjs", clientPath], {
    encoding: "utf8",
