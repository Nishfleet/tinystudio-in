...
a name with no live CTA is dormant, not attached to unrelated links. Any
new placement needs a new registered name, added here, to the allowlist in
...
## RetentionThe static site stores nothing: this layer adds no cookie, no server log, no
