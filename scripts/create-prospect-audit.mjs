...
"If useful, I can run a ${config.offerName} for this one highest-leverage page, with human review, a fault map, rewrite or redesign, implementation pass or dev-ready handoff, proof, measurement plan, and 14-day implementation tracking."
`
);
...
Show one visible fault in under 2 minutes, then explain the sprint in one clear ask.
`
);
