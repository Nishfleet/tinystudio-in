...
"If useful, I can fix this one highest-leverage page with the human-reviewed ${config.offerName}: a fault map, rewrite or redesign, implementation pass or dev-ready handoff, proof, measurement plan, and 14-day implementation tracking."
`
);
