...
"If useful, I can fix this one highest-leverage page in a human-reviewed, fixed-scope sprint with a fault map, rewrite or redesign, implementation pass or dev-ready handoff, proof, measurement plan, and 14-day implementation tracking."
`
);
...
Show one visible fault in under 2 minutes, then explain the fixed-scope sprint in one clear ask.
`
);
