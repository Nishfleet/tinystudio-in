...
handleHelp(process.argv.slice(2), `Usage: node scripts/export-owned-product-case-studies.mjs [--output=growth-brain/ops/owned-product-case-studies.md] [--html=growth-brain/ops/owned-product-case-studies.html]`);
const clients = [
...
const outputPath = resolveOutputPath(outputArg?.split("=").slice(1).join("="), { fallback: "growth-brain/ops/owned-product-case-studies.md" });
const htmlPath = resolveOutputPath(htmlArg?.split("=").slice(1).join("="), { flag: "--html", fallback: "growth-brain/ops/owned-product-case-studies.html" });
