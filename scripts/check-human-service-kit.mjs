...
for (const phrase of ["7-Day Website Revenue Leak Fix Sprint", "$1,000 founder pilot", "one highest-leverage page", "rewrite or redesign", "14-day implementation tracking", "Human review gates", "Client delay pauses the clock"]) {
...
if (existsSync(onePagerPath)) {
	...
	if (!onePager.includes("7-Day Website Revenue Leak Fix Sprint")) failures.push("Managed IT one-pager has stale product name")
