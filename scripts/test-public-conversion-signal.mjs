...
if (existsSync(join(ROOT, DOCS_PATH))) {
  ...
  ok(docs.includes("Website Correction application — from"), "docs pin the operator-visible subject format")
...
ok(
  contactHtml.includes('"Website Correction application — from " + source') && contactHtml.includes("encodeURIComponent"),
