...
// outline against the worktree HTML; this guard re-asserts it against the
...
// re-opening the 2026-08-09 dogfood item "Heading hierarchy needs cleanup
// on /contact" (finding 52753880dfc7, repaired in source by PR #18).
const LIVE_PAGES = [
  {
    name: "Contact",
...
ok(
  pkg.scripts["site:check-live-heading-hierarchy"] === "node scripts/test-public-live-heading-hierarchy.mjs",
  "npm run site:check-live-heading-hierarchy runs this guard on demand"
)
ok(
