...
// The Grok review finding observed that 6 trust/support pages had no JSON-LD
// while the other 6 public pages did; the 07acd07 live bundle in fact shipped
// JSON-LD on only 4 of 12 pages. This list mirrors every public path the
// release lane deploys so the detector proves the site-wide invariant.
const PUBLIC_PATHS = [
  "/",
  "/contact/",
  "/support/",
