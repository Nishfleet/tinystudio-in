...
|---|---|---|
| TinyStudio runs a human-reviewed ${config.offerName} for one highest-leverage page with a leak map, rewrite or redesign, implementation pass or handoff, proof, measurement plan, one client revision, and 14-day implementation tracking. | growth-brain/offer.md | yes |
