...
handleHelp(process.argv.slice(2), `Usage: node scripts/export-owned-handoff-loom-cockpit.mjs [--output=growth-brain/ops/owned-handoff-loom-cockpit.md] [--html=growth-brain/ops/owned-handoff-loom-cockpit.html]`);
