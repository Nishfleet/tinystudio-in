...
try {
	...
	const staleSevenDayPromise = /\b(?:seven[- ]day|7[- ]day) sprint\b|\bfix(?:es)? in 7 days\b|\b7 working days from Day 0\b/i;
	...
	for (const stale of ["seven-day sprint", "7-day sprint", "fix in 7 days", "7 working days from Day 0"]) {
