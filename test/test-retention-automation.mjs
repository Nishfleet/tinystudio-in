...
import {RETENTION_AUTOMATION_PROMPT} from "../src/lib/retention-automation.mjs"

const script = join(dirname(fileURLToPath(import.meta.url)), "..", "src", "check-retention-automation.mjs")
...
try {
	...
	{
		const {canonicalMainWorktree} = await import("../src/lib/retention-preflight.mjs")
